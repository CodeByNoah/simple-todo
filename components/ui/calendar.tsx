...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        // حالت انتخاب شده تکی و Hover Override
        ...
        // حالت شروع رنج و Hover Override
        ...
        // حالت پایان رنج و Hover Override
        ...
        // ... بقیه کلاس‌های Tailwind (مانند focused, etc.)
...
const MemoziedCalendar = React.memo(Calendar);

export { MemoziedCalendar as Calendar, CalendarDayButton };
